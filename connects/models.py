...
class Contact(models.Model):
    listing = models.ForeignKey(
        "listings.Listing", on_delete=models.DO_NOTHING, verbose_name=_("Listing")
    )
    ...
    contact_date = models.DateTimeField(
        default=datetime.now, blank=True, verbose_name=_("Contact date")
    )
...
class ChatMessage(models.Model):
    contact = models.ForeignKey(
        Contact, on_delete=models.PROTECT, verbose_name=_("Contact listing")
    )
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.PROTECT, verbose_name=_("User")
    )
    ...
    timestamp = models.DateTimeField(
        default=datetime.now, blank=True, verbose_name=_("Date and iime")
    )
