...
class ListingListView(ListView):
    ...
    paginate_by = 4
    object_list = Listing.objects.order_by("-created").filter(is_published=True)

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["listings"] = self.object_list
        # Showcase Section Infos
        context["title"] = _("Browse our properties")
        # SEO
        context["page_title"] = _("Browse Property Listings")
        context["page_description"] = _("Realty Management." "Browse all properties.")
        return context
...
class ListingDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["page_description"] = _(
            "Realty Management."
            "Description and attribute listing of specific properties"
        )
        return context
