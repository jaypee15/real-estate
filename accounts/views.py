...
def register(request):
    ...
    context = {
        ...
        "page_description": _("Realty Management. " "Regitration page."),
    }
    ...
    if request.method == "POST":
        ...
        if password == password2:
            ...
            if User.objects.filter(email=email).exists():
                ...
                user.save()
                messages.success(request, _("You are now registered and can log in"))
...
def login(request):
    ...
    context = {
        ...
        "page_description": _("Realty Management. Login page."),
    }
    if request.method == "POST":
        email = request.POST["email"]
        password = request.POST["password"]
...
def password_reset_request(request):
    ...
    context = {
        ...
        "page_description": _("Realty Management. " "Password reset page."),
    }
    return render(
        request=request,
        context=context,
